...
struct DefaultMenu: Menu {
    ...
    private let list: [DefaultProduct] = [
        ...
        DefaultProduct(category: .desert, name: "티라미수", englishName: "Tiramisu", price: 6500, thumbnailImageString: "image05.png", stock: 2),
        DefaultProduct(category: .desert, name: "초코케이크", englishName: "Chocolate Cake", price: 6000, thumbnailImageString: "image05.png", stock: 2),
    ]
